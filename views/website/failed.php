		...
		<div class="row">
			<div class="grey lighten-3 col l6 push-l3 s12 login-box">
				<div class="col s12 center-align" style="margin-top: 30px;">
					<img src="/img/fail_icon.png" class="responsive-img">
				</div>
				<div class="col s12 center-align" style="margin-bottom: 30px; margin-top: 30px;">
					<hr />
					<h5 style="margin-top: -15px;"><span class="grey lighten-3"> &nbsp; &nbsp; Booking Failed &nbsp; &nbsp; </span></h5>
				</div>
				<div class="col s12 center-align" style="margin-bottom: 25px;">
					Sorry! Some sort of error happened.
				</div>
			</div>
		</div>
		<div class="row">
			<div class="grey lighten-2 col l6 push-l3 s12 login-box">
				<a href="/account/"><i class="material-icons">account_circle</i> <span>My Account</span></a>
			</div>
		</div>
	</div>
</section>